...
<body class="subpage">
		...
		<div class="row " style="margin-top: 50px;">
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="thumbnail row" id="content">
					...
					<table class="table">
						<tr>
							<td colspan="" rowspan="10" headers="" id="picpath"></td>
							<td>活动类型：</td>
							<td id="type"></td>
						</tr>
						<tr>
					...
					<div class="row" style="margin-top: 50px;">
						<p id="description" class="bg-info col-md-7"
							style="text-indent: 2em; line-height: 2.5em; padding: 20px; margin: 0;"></p>
						<div class="col-md-1"></div>
						<div class="col-md-4">
							<div class="row" style="margin-top:-37px;">
								<div class="col-md-12" style="width: 300px;">
									<h4 class="text-info text-left">活动地点</h4>
								</div>
								<div id="map" class="col-md-12 thumbnail"
	...
	<script type="text/javascript"
		src="http://api.map.baidu.com/api?v=2.0&ak=YbsihyA7RczVttYGjzDWwbqman5NZzKe"></script>
	...
	<script type="text/javascript">
		$.get("${pageContext.request.contextPath}/"+
				"servlet/activityServlet?method=detailActivity&activityid=<%=activityid%>",
						function(data, status) {
							if (data != null) {
								var sign_up1 = "<a href='${pageContext.request.contextPath }/servlet/joinActivityServlet?method=add_joinActivity&activityid="
										+ data.activityid
										+ "&phone=${user.phone}' class='btn btn-success col-md-12'"
								...
								var point = new BMap.Point(116.331398,
										39.897445);
